...
Made in 16/11/2023 at exactly 6:26 with the help of google and my brain probably :)
...
In short, a typo. In full, the WordPress app was encountering a critical error in wp-settings.php when tyring to load the file class-wp-locale.phpp. The correct file name, located in the wp-content directory of the application folder, was class-wp-locale.php.

A simple fix on the typo does the job. C'est pas mechant !
...
My imagination is wild and google is wide.
